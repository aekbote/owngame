...
var starDisplay,emptyStar,twoStar, oneStar;
...
function setup() 
{
  ...
  starDisplay.changeAnimation("emptyStar");
  ...
  star1 = createSprite(330,50,20,20);
  star1.addImage(starImg);
  star1.scale = 0.02;

  star2 = createSprite(100,370,20,20);
